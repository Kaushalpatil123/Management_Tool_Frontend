...
import { updateQuote } from "../../Store/slices/QuoteSlice";
import { useDispatch } from "react-redux";

const EditQuote = ({ setShowQuote, Refresh, selectedQuote }) => {
    console.log("fasfasf", selectedQuote)
    ...
    // ✅ Prefill form & items from selectedQuote
    useEffect(() => {
        if (selectedQuote) {
            setForm({
                ...
                date: selectedQuote.date ? selectedQuote.date.split("T")[0] : "",
                expireDate: selectedQuote.expireDate ? selectedQuote.expireDate.split("T")[0] : "",
    ...
    const handleUpdate = async () => {
        try {
            ...
            await dispatch(updateQuote({ id: selectedQuote._id, data: payload })).unwrap();
            ...
            console.error(error);
            toast.error(error || "Error updating quote");
        }
    };
